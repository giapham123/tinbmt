            ...
            <div class="bs-welcome-panel-content">
                <div class="bs-welcome-panel-header">
                    ...
                    <div class="bs-welcome-panel-header-image">
                        <img class='blockspare-notice-image' src={blockspare_dashboard.static_img + 'admin/assets/images/notice-background.webp'} height="200" width="200" />
                    </div>
                </div>
                <div class='bs-welcome-panel-column-container'>
                    ...
                    <div class='bs-welcome-panel-column'>
                        ...
                        <div class='bs-welcome-panel-column-content'>
                            <h3>{__('Elevate Your Site Instantly!', 'blockspare')} </h3>
                            <p>{__('Import templates, Customize, Publish with Ease! Limitless style options, and animations. Our docs, and support team are here to guide you!', 'blockspare')} </p>

                            <a href="https://blockspare.com/" target="_blank" class="blockspare-notice-link">{__('Learn More about Blockspare', 'blockspare')}</a>
                        </div>
                    </div>
