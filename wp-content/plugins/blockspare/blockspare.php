<?php
     ...
     * Description:       Expertly Crafted Patterns & Page Builder Gutenberg Blocks for Blog, Magazine, Newspaper, and Agency. One-click Import, No Coding Hassle! Explore our Patterns Library, and enjoy Just Importing, Customizing, and Publishing Your Site with Ease!
     * Version:           3.2.0
     * Author:            Blockspare
    ...
    defined('ABSPATH') or die('No script kiddies please!');  // prevent direct access
                ...
                defined('BLOCKSPARE_VERSION' ) || define('BLOCKSPARE_VERSION',  '3.2.0');
